...
async function test() {
  ...
  try {
    ...
    // 4. TikTok動画URLを送信
    const tiktokUrl = 'https://www.tiktok.com/@mote_cosme/video/7586615913298840852'
    ...
    // スクリーンショットを保存
    await page.screenshot({ path: '/Users/hantaku/Downloads/BuzzTeacher/web/test-full-screenshot.png', fullPage: true })
