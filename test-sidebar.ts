...
async function test() {
  ...
  try {
    ...
    // 3. スクリーンショット
    await page.screenshot({ path: '/Users/hantaku/Downloads/BuzzTeacher/web/test-sidebar.png', fullPage: true })
    ...
    await page.screenshot({ path: '/Users/hantaku/Downloads/BuzzTeacher/web/test-sidebar-error.png', fullPage: true })
  } finally {
    await browser.close()
  }
}
