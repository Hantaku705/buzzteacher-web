...
この動画を分析して、以下のフォーマットで日本語で出力してください。
**重要**: 必ず各セクションの見出しは「### 」から始めてください。

### 動画内容
**ナレーション**: （音声の文字起こしを1-2文で要約）
**テロップ**: （主要なテロップを箇条書き）
**カット**: 約○カット、平均○秒/カット

### 構成分析
**冒頭フック**: （最初の3秒で何が起きているか）
**構成タイプ**: （Before/After型、ストーリー型、チュートリアル型など）
**見どころ**: （視聴者が最も引き込まれるポイント）

### バズ要因
**フック力**: ○/5（視聴を止める力の評価と理由）
**稀有度**: ○/5（見たことない度合いの評価と理由）
**情報密度**: ○/5（テンポ感の評価）
**コメント誘導**: （コメントを促す仕掛けの有無と内容）

各セクションは簡潔に、要点のみをまとめてください。
`;
