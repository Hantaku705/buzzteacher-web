...
export const AVAILABLE_CREATORS: CreatorInfo[] = [
  ...
  { id: 'galileo', name: 'ガリレオ', description: '前薗孝彰 - アルゴリズム×構成術' },
  { id: 'matsudake', name: 'マツダ家の日常', description: '関ミナティ - リサーチ×ブランド化' },
  { id: 'mote_cosme', name: 'モテコスメちゃん', description: '美容・コスメレビュー特化' },
]
...
- **トレンドに乗る**: 伸びてる動画を参考にアレンジ`,
  ...
  mote_cosme: `## モテコスメちゃんの核心
- **ターゲット明確化**: 「すきぴを沼らせたい」女子向け
- **美容・コスメレビュー特化**: モテをテーマにした商品紹介
- **NADESHIKO beauty所属**: インフルエンサー事務所のノウハウ活用
- **ビフォーアフター重視**: 変化が見える構成`,
}
